...
namespace FaceDetection
{
   ...
   //     if (result == null) { continue; }
    ...
    protected override void OnUpdate(float timeStep)
    {
      ...
      //System.Diagnostics.Debug.WriteLine($"OnUpdate interval: {now - lastUpdate}");
      //lastUpdate = now;
      ...
      cameraTexture.SetSize(width, height, Urho.Graphics.RGBAFormat, TextureUsage.Dynamic);
